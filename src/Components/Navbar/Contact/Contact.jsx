...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "2e718223-5d3b-4147-898c-f535ea651cc6");
    ...
    <div className='contact'>
        <div className="contact-col">
            ...
            <p>
                ...
                suggestions are imporant to us as we strive to provide exceptional service to our university community.
            </p>
            <ul>
                <li><img src={mail_icon} alt="mail" />Contact@princeton.com</li>
                <li><img src={phone_icon} alt="phone" />99002 23099</li>
                <li><img src={location_icon} alt="location" />23, st.thomas Ave, <br/> Chennai</li>
           </ul>
        </div>
        <div className="contact-col">
